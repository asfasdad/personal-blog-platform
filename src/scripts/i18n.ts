...
const dictionary: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "admin.orClickUpload": "or click to upload",
    ...
    "admin.authorBio": "Author Bio",
    "admin.socialLinks": "Social Links",
    "admin.features": "Features",
    "admin.enableComments": "Enable Comments",
    "admin.enableRss": "Enable RSS Feed",
    "admin.enableSearch": "Enable Search",
    "admin.enableNewsletter": "Enable Newsletter",
    "admin.integrations": "Integrations",
    "admin.googleAnalytics": "Google Analytics ID",
    "admin.cloudflareAnalytics": "Cloudflare Analytics Token",
  ...
  zh: {
    ...
    "admin.uploadMedia": "上传媒体",
    "admin.upload": "上传",
    "admin.dropFiles": "将文件拖到这里",
    "admin.orClickUpload": "或点击上传",
    ...
    "admin.authorName": "作者名称",
    "admin.authorBio": "作者简介",
    "admin.socialLinks": "社交链接",
    "admin.features": "功能开关",
    "admin.enableComments": "启用评论",
    "admin.enableRss": "启用 RSS",
    "admin.enableSearch": "启用搜索",
    "admin.enableNewsletter": "启用订阅",
